...
namespace Stack.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        private readonly QuestionsModel _model = new QuestionsModel();
        // GET: Articles
        [Route("Questions")]
        public ActionResult Index()
        {
            _model.GetQuestionsOnMenuItemId(0);
            //_model.MenuItemSeo = id;
            return View(_model);
        }
         //[Route("Questions/{pageNumber}")]
        public ActionResult Index(int pageNumber)
        {
            _model.GetQuestionsOnMenuItemId(pageNumber);
            return View("_questions", _model.QuestionsList);
        }
        //// GET: RecentArticles
